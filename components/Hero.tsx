  ...
  return (
    <section className="relative h-screen w-full overflow-hidden text-white bg-[#0a0a0a]">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-4">
        ...
        <form className="flex flex-col sm:flex-row gap-3 w-full max-w-[480px]" onSubmit={(e) => e.preventDefault()}>
          <input 
            type="email" 
        ...
        {/* Countdown Timer */}
        <div className="mt-16 flex items-center gap-8 sm:gap-12 font-afacad text-white/90">
